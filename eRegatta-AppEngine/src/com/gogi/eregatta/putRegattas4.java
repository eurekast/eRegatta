...
public class putRegattas4 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		try {
			page = webClient.getPage("http://members.sailing.org/regattas.php?max=125&begin=376&includeref=092CC935AC8B48B299B32C7E69CC3F17");
